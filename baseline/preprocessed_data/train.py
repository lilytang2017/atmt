...
def get_args():
    ...
    parser.add_argument('--max-tokens', default=1000, type=int, help='maximum number of tokens in a batch')
    ...
    parser.add_argument('--restore-file', default='checkpoint_last.pt', help='filename to load checkpoint') ############## or: default='checkpoint_last.pt'
