...
def get_args():
    ...
    parser.add_argument('--checkpoint-path', default='checkpoints_baseline/checkpoint_best.pt', help='path to the model file') # default='checkpoints/checkpoint_best.pt'
